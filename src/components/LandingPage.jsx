      ...
      <div data-scroll data-scroll-section data-scroll-speed="-0.3" className="w-full h-screen bg-zinc-900 pt-1">
                ...
                <div className="w-fit flex overflow-hidden">
                  {index === 1 && (
                    <motion.div
                      ...
                      className="mr-[1vw] w-[9vw] h-[5.5vw]   relative top-[1vw] bg-green-500"
                    ></motion.div>
                  )}
        ...
        <div className="border-t-[1px] border-zinc-800 mt-20 flex justify-between items-center py-5 px-20">
          ...
          <div className="start flex items-center gap-5 cursor-pointer">
            <div className="px-5 py-2 border-[2px] border-zinc-500 rounded-full font-medium text-sm  uppercase text-md">
              Start the Project
            </div>
